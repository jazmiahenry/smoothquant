"""
Initialize SmoothQuant method as defined in paper: https://arxiv.org/abs/2211.10438. 
"""
...
def smooth_ln_fcs(ln, fcs, act_scales, alpha=0.5):
    """
    Normalize using LayerNorm in Linear module. 
    Input: 
        fcs: list
        ln: nn.LayerNorm
        act_scales: Tensor(int)
        alpha: int
    """
...
def smooth_lm(model, scales, alpha=0.5):
    """
    Test for module type- OPTDecoderLayer or BloomBlock. 
    """
